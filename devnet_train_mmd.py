...
from modeling.devnet_mmd import SemiADNet
...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        self.mmd_loss = build_criterion("mmd", args)
    ...
    def train(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            mmd_loss = self.mmd_loss(domain_label, feature)
            loss = devnet_loss + self.args.lambda0 * mmd_loss
            ...
            sub_train_loss_list.append([devnet_loss.item(),mmd_loss.item()])
    ...
    def eval(self, dataset):
        ...
        for i, sample in enumerate(tbar):
            ...
            if self.args.cuda:
                image, target = image.cuda(), target.cuda()
            with torch.no_grad():
                output, features, _ = self.model(image.float())
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lambda0", type=int, default=4)
    ...
    if args.data_name.__contains__("PACS"):
        file_name = f'data_name={args.data_name},backbone={args.backbone},domain_cnt={args.domain_cnt},normal_class={args.normal_class},anomaly_class={args.anomaly_class},batch_size={args.batch_size},steps_per_epoch={args.steps_per_epoch},epochs={args.epochs},lr={args.lr},freeze={args.freeze},lambda0={args.lambda0},contamination={args.contamination_rate},cnt={args.cnt}'
