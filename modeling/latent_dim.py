...
class VAE(nn.Module):
    def __init__(self, args):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.LeakyReLU(),
            nn.Conv2d(32, 32, 3, stride=1, padding=1),  # Output: 32x16x16
            nn.BatchNorm2d(32),
            nn.LeakyReLU(),
            ...
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            nn.Conv2d(64, 64, 3, stride=1, padding=1), # Output: 64x4x4
            nn.BatchNorm2d(64),
            nn.ReLU()
        )
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(64, 64, 3, stride=1, padding=1), # Output: 64x4x4
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            ...
            nn.BatchNorm2d(32),
            nn.LeakyReLU(),
            nn.ConvTranspose2d(32, 32, 3, stride=1, padding=1), # Output: 32x16x16
            nn.BatchNorm2d(32),
            nn.LeakyReLU(),
...
class SemiADNet(nn.Module):
    ...
    def forward(self, image, domain_label, target, weights=None):
        with torch.no_grad():
            reconstructions, posterior = self.AE(image)
        
        return None, reconstructions, None, None, None, None