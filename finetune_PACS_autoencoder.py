...
from PACS_dataloader import PACSDataset
...
args.add_argument("--anomaly_class", nargs="+", type=int, default=[1,2,3,4,5,6])
...
train_dataset = PACSDataset(args, 'train', data_path)
train_dataloader = DataLoader(train_dataset, num_workers=8, batch_size=batch_size, shuffle=True)
logger = ImageLogger(batch_frequency=logger_freq)
trainer = pl.Trainer(precision=32, callbacks=[logger],  accumulate_grad_batches=8, gpus=[0], max_epochs = 1000)
